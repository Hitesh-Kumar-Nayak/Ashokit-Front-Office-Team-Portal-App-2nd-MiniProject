package in.hiteshit.service.impl;
...
import in.hiteshit.repo.UserDtlsRepo;
import in.hiteshit.service.UserService;
import in.hiteshit.util.EmailUtils;
import in.hiteshit.util.PwdUtils;
...
public class UserServiceImpl implements UserService {
	...
	public boolean signup(SignUpForm form) {
		...
		body.append("<br/>");
		body.append("<a href=\"http://localhost:8084/unlock?email="+to+"\")>Click Here To Unlock Your Account</a>");
